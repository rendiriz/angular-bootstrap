...
@Component({
  ...
  styleUrls: ['./foundations-page.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class FoundationsPageComponent implements OnInit, OnChanges, OnDestroy, AfterViewInit {
  moment: any = moment;
  ...
  settingsAll(): void {
    this.translateService.get('seo.foundations-page').subscribe((trans) => {
